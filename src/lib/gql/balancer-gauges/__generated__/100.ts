...
export type Aggregation_Interval = "day" | "hour" | "%future added value";
...
export type GaugeInjector_OrderBy = "id" | "%future added value";
...
export type GaugeType_OrderBy = "id" | "name" | "%future added value";
...
export type GaugeSharesByUserQuery = {
  __typename?: "Query";
  gaugeShares: Array<{
    __typename?: "GaugeShare";
    balance: any;
...
export function getSdk(
  ...
  return {
    GaugeSharesByUser(
      variables: GaugeSharesByUserQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GaugeSharesByUserQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GaugeSharesByUserQuery>(
            GaugeSharesByUserDocument,
            variables,
...
export function getSdkWithHooks(
  ...
  return {
    ...sdk,
    useGaugeSharesByUser(
      variables: GaugeSharesByUserQueryVariables,
      config?: SWRConfigInterface<GaugeSharesByUserQuery, ClientError>
    ) {
      return useSWR<GaugeSharesByUserQuery, ClientError>(
        genKey<GaugeSharesByUserQueryVariables>("GaugeSharesByUser", variables),
        () => sdk.GaugeSharesByUser(variables),
        config
      );
    },
  };
