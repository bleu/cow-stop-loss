...
export type GaugeSharesByUserQueryVariables = Exact<{
  user: Scalars['String']['input'];
}>;


export type GaugeSharesByUserQuery = { __typename?: 'Query', gaugeShares: Array<{ __typename?: 'GaugeShare', balance: any, gauge: { __typename?: 'LiquidityGauge', id: string, poolAddress: any, poolId?: any | null, totalSupply: any, isPreferentialGauge: boolean, isKilled: boolean } }> };


export const GaugeSharesByUserDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GaugeSharesByUser(variables: GaugeSharesByUserQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GaugeSharesByUserQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GaugeSharesByUserQuery>(GaugeSharesByUserDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GaugeSharesByUser', 'query', variables);
    }
  };
}
...
export function getSdkWithHooks(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  ...
  return {
    ...sdk,
    useGaugeSharesByUser(variables: GaugeSharesByUserQueryVariables, config?: SWRConfigInterface<GaugeSharesByUserQuery, ClientError>) {
      return useSWR<GaugeSharesByUserQuery, ClientError>(genKey<GaugeSharesByUserQueryVariables>('GaugeSharesByUser', variables), () => sdk.GaugeSharesByUser(variables), config);
    }
  };
}
