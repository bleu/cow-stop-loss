...
const baseDark =
  "bg-blue4 text-background data-[highlighted]:bg-blue6 data-[highlighted]:text-slate-12";
const baseLight =
  "bg-white text-slate12 data-[highlighted]:bg-blue5 data-[highlighted]:text-background";
      ...
      <SelectPrimitive.Root {...props}>
        ...
        <SelectPrimitive.Portal>
          <SelectPrimitive.Content
            className={cn(
              "overflow-hidden   shadow-[0px_10px_38px_-10px_rgba(22,_23,_24,_0.35),0px_10px_20px_-15px_rgba(22,_23,_24,_0.2)]",
              baseTheme
            )}
          >
